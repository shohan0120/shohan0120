<h1 align="center">Hey There 👋</h1>h1>
  ...
  - - 🧪 Focusing on **Playwright (TypeScript), REST API testing, and CI sharding & reporting**
    - - 🤖 Exploring **AI-assisted QA workflows and performance testing**
      - - 📍 Based in **Bangladesh**
        ...
        - > Active contributor in **getdokan** — opening and merging pull requests and filing detailed, reproducible issues, mostly around E2E stability, CI infrastructure, and regression coverage.
          >
          > ## 🏆 Achievements
          >
          ...
          >        
          >         - A live count and feed of my merged pull requests across open-source repositories — automatically updated as new PRs are merged.
          >        
